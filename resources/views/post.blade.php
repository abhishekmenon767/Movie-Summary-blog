                   ...
                   <h2 class="pt-2 tm-color-primary tm-post-title">{{$post->title}}</h2>
                    ...
                    <div class="col-lg-8 tm-post-col">
                        <div class="tm-post-full">
                            <center>  <img src="/storage/{{$post->thumbnail}}" alt="Thumbnail" class="rounded-xl" style="max-width: 500px; height: auto;"></center>
                        </div>
                    </div>


                    <p class="tm-mb-40">Published <time>{{$post->created_at->diffForHumans()}}</time><br>Published by <a href="/authors/{{$post->author->username}}">{{$post->author->name}}</a></p>

                    <div>
                        {{$post->body}}
                        <br>
                        <span class="d-block text-right tm-color-primary">Belongs to <a href="/categories/{{$post->category->slug}}">{{$post->category->name}}</a> Category</span>
                    </div>
                        ...
                        <section class="col-span-8 col-start-5 mt-10">
                            ...
                            <div class="mt-8">
                                ...
                                <form action="{{ route('comments.store') }}" method="POST" class="mt-4">
                                    ...
                                    <div class="mb-4">
                                        <label for="body" class="block font-semibold">Your Comment:</label>
                                        <textarea name="body" id="body" rows="4" class="form-textarea mt-1 block w-full" required></textarea>
                                    </div>
